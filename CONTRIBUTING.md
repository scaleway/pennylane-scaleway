# Contribute to `pennylane-scaleway`
...
- The version of `pennylane-scaleway` you are using
- Python version
...
- Does this align with the goals of `pennylane-scaleway`?
...
- Open a pull request against `pennylane-scaleway` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `pennylane-scaleway` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
